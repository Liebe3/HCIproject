...
function generate_eqation(){
  ...
  var wrongans1 = Math.random() *30
  var wrongans2 = Math.random() *30
  ...
  option3.innerHTML = switchans[2];
   ...
   option1.innerHTML = switchans[0].toFixed(2);

   option2.innerHTML = switchans[1].toFixed(2);
  

   option3.innerHTML = switchans[2].toFixed(2);
}    
    


    option1.addEventListener("click",function(){
  if (option1.innerHTML == finalAnswer){
    generate_eqation();
    audio2.play();
  }
  else{
...
option2.addEventListener("click",function(){
  if (option2.innerHTML == finalAnswer){
    generate_eqation();
    audio2.play();
  }
  else{
...
option3.addEventListener("click",function(){
  if (option3.innerHTML == finalAnswer){
    generate_eqation();
    audio2.play();
  }
  else{
